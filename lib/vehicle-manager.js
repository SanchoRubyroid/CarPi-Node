...
exports.removeVehicle = function(socket) {
  var vehicle_to_remove = getVehicleBySocket(socket.id))
...
exports.processVideoData = function(video_socket, data) {
  var vehicle = getVehicleByVideoSocketID(video_socket.id)
  vehicle.videoData(data)
}

setVehicleName = function(data) {
...
getVehicleBySocketID = function(socket_id) {
  return vehicles.find(function(vehicle){
    vehicle.getSocketID() == socket_id
  })
}

getVehicleByControlSocketID(socket_id) {
  return vehicles.find(function(vehicle){
    vehicle.getControlSocketID() == socket_id
  })
}

getVehicleByVideoSocketID(socket_id) {
  return vehicles.find(function(vehicle){
    vehicle.getVideoSocketID() == socket_id
  })
}
